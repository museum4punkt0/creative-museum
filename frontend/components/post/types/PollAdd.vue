  ...
  <div w:flex="~ col 1" w:h="full">
    ...
    <div w:flex="~ col 1" w:h="full" w:justify="between" w:pr="6" w:pb="6" w:pl="6">
      <div w:flex="~ col grow">
        ...
        <textarea type="text" v-model="description" class="input-text" w:mt="4" w:min-h="1/5" :placeholder="$t('post.types.poll.pollDescription')" />
        <div v-for="(option, index) of options" w:mt="4">
          ...
          <div w:flex="~ row" w:justify="between" w:align="items-center">
            <input v-model="option.value" type="text" class="input-text" />
