namespace :deploy do
    after :published, :frontend do
        ...
        on roles(:all) do
            ...
            execute "bash -c \"/var/www/.npm-global/bin/pm2 startOrRestart /var/www/creative-museum-#{stage}/ecosystem.config.js\""
            execute "bash -c \"curl #{backend_url}/flush.php && rm #{release_path}/backend/public/flush.php\""
        end
    end
end